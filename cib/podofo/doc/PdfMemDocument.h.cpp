...
public:
  using __zz_cib_Proxy = __zz_cib_Proxy_t<::PoDoFo::PdfMemDocument>;
  ...
  {}
  __zz_cib_Generic(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, bool bOnlyTrailer)
    : ::PoDoFo::PdfMemDocument::PdfMemDocument(    std::move(bOnlyTrailer))
    , __zz_cib_h_(__zz_cib_proxy)
    , __zz_cib_mtbl_helper(__zz_cib_mtbl)
  {}
  __zz_cib_Generic(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, const char* pszFilename, bool bForUpdate)
    : ::PoDoFo::PdfMemDocument::PdfMemDocument(    std::move(pszFilename),
    std::move(bForUpdate))
    , __zz_cib_h_(__zz_cib_proxy)
    , __zz_cib_mtbl_helper(__zz_cib_mtbl)
  {}
  ...
  __ZZ_CIB_DELEGATOR_MEMBERS(__zz_cib_Generic, ::PoDoFo::PdfMemDocument)
...
private:
  ...
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class456::__zz_cib_Generic::__zz_cib_methodid;
};
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfMemDocument> : public ::PoDoFo::PdfMemDocument {
  using __zz_cib_Delegatee = __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfMemDocument>;
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_0(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfMemDocument>(__zz_cib_proxy, __zz_cib_mtbl);
  }
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_1(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, __zz_cib_AbiType_t<bool> bOnlyTrailer) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfMemDocument>(__zz_cib_proxy, __zz_cib_mtbl,     __zz_cib_::__zz_cib_FromAbiType<bool>(bOnlyTrailer));
  }
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_2(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, __zz_cib_AbiType_t<const char*> pszFilename, __zz_cib_AbiType_t<bool> bForUpdate) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfMemDocument>(__zz_cib_proxy, __zz_cib_mtbl,     __zz_cib_::__zz_cib_FromAbiType<const char*>(pszFilename),
  ...
  static ::PoDoFo::PdfDocument* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class417(::PoDoFo::PdfMemDocument* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::PoDoFo::PdfMemDocument* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class417(::PoDoFo::PdfDocument* __zz_cib_obj) {
    return __zz_cib_DownCast<::PoDoFo::PdfMemDocument*>(__zz_cib_obj);
  }
  static std::uint32_t __zz_cib_decl __zz_cib_get_class_id(::PoDoFo::PdfMemDocument** __zz_cib_obj) {
    ...
    return __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class456::__zz_cib_classid;
  }
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfMemDocument>::__zz_cib_cast_to___zz_cib_Class417),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfMemDocument>::__zz_cib_cast_from___zz_cib_Class417),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfMemDocument>::__zz_cib_get_class_id),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfMemDocument>::__zz_cib_release_proxy)
  };
  static const __zz_cib_MethodTable methodTable = { methodArray, 52 };
  return &methodTable;
}
}}}
