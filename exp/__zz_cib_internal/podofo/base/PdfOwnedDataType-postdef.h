...
struct __zz_cib_Helper<::PoDoFo::PdfOwnedDataType, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfOwnedDataType>);
  ...
  friend class ::PoDoFo::PdfOwnedDataType;
  CibPoDoFo::__zz_cib_local_proxy_mgr<_ProxyClass> proxyMgr;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class392::__zz_cib_methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class392::__zz_cib_classid))
  {}
  ...
  static __zz_cib_AbiType __zz_cib_new_1(::PoDoFo::PdfOwnedDataType* __zz_cib_h_) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfOwnedDataType*, const __zz_cib_MethodTable*);
  ...
  static __zz_cib_AbiType __zz_cib_copy_2(::PoDoFo::PdfOwnedDataType* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfOwnedDataType*, const __zz_cib_MethodTable*, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_copy_2>(
      __zz_cib_h_, __zz_cib_get_proxy_method_table(),
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto GetOwner_3(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetOwner_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto GetOwner_4(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetOwner_4>(
      __zz_cib_obj
      );
  }
  ...
  template <typename _RT, typename ..._Args>
  static auto GetIndirectObject_6(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetIndirectObject_6>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto GetObjectOwner_7(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetObjectOwner_7>(
      __zz_cib_obj
      );
  }
  template <typename _RT, typename ..._Args>
  static auto SetOwner_8(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::SetOwner_8>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  ...
  static void __zz_cib_release_proxy(::PoDoFo::PdfOwnedDataType* __zz_cib_obj) {
