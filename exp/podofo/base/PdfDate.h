...
#include "__zz_cib_internal/podofo/base/PdfDate-predef.h"
...
namespace PoDoFo
{
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfDate, PoDoFo::PdfDate);
  };
}

#include "__zz_cib_internal/podofo/base/PdfDate-postdef.h"
#endif
