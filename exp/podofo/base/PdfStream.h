...
#include "__zz_cib_internal/podofo/base/PdfStream-predef.h"
...
namespace PoDoFo
{
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfStream, PoDoFo::PdfStream);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfStream-postdef.h"
#endif
