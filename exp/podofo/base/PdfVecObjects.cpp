...
PoDoFo::PdfVecObjects::Observer::Observer()
  : PoDoFo::PdfVecObjects::Observer(__zz_cib_MyHelper::__zz_cib_new_0(
    this))
  {}
}
namespace PoDoFo {
...
PoDoFo::PdfVecObjects::StreamFactory::StreamFactory()
  : PoDoFo::PdfVecObjects::StreamFactory(__zz_cib_MyHelper::__zz_cib_new_0(
    this))
  {}
}
namespace __zz_cib_ {
...
struct __zz_cib_Delegator<::PoDoFo::PdfVecObjects::Observer> {
  ...
  static void __zz_cib_decl __zz_cib_delete_5(::PoDoFo::PdfVecObjects::Observer* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfVecObjects::Observer>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfVecObjects::Observer>::__zz_cib_get_proxy_method_table() {
...
struct __zz_cib_Delegator<::PoDoFo::PdfVecObjects::StreamFactory> {
  ...
  static void __zz_cib_decl __zz_cib_delete_1(::PoDoFo::PdfVecObjects::StreamFactory* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfVecObjects::StreamFactory>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfVecObjects::StreamFactory>::__zz_cib_get_proxy_method_table() {
