...
public:
  ...
  void LogMessage(::PoDoFo::ELogSeverity eLogSeverity, const wchar_t* pszPrefix, const wchar_t* pszMsg, va_list& args) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_Proxy, __zz_cib_AbiType_t<decltype(eLogSeverity)>, __zz_cib_AbiType_t<decltype(pszPrefix)>, __zz_cib_AbiType_t<decltype(pszMsg)>, __zz_cib_AbiType_t<decltype(args)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::LogMessage_0>(
      __zz_cib_h_,
  ...
  void LogMessage(::PoDoFo::ELogSeverity eLogSeverity, const char* pszPrefix, const char* pszMsg, va_list& args) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_Proxy, __zz_cib_AbiType_t<decltype(eLogSeverity)>, __zz_cib_AbiType_t<decltype(pszPrefix)>, __zz_cib_AbiType_t<decltype(pszMsg)>, __zz_cib_AbiType_t<decltype(args)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::LogMessage_1>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(eLogSeverity)>(std::move(eLogSeverity)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(pszPrefix)>(std::move(pszPrefix)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(pszMsg)>(std::move(pszMsg)),
...
struct __zz_cib_Delegator<::PoDoFo::PdfError::LogMessageCallback> : public ::PoDoFo::PdfError::LogMessageCallback {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_0(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfError::LogMessageCallback>(__zz_cib_proxy, __zz_cib_mtbl);
  }
  ...
  static std::uint32_t __zz_cib_decl __zz_cib_get_class_id(::PoDoFo::PdfError::LogMessageCallback** __zz_cib_obj) {
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfError::LogMessageCallback>::__zz_cib_get_class_id),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfError::LogMessageCallback>::__zz_cib_release_proxy)
  };
