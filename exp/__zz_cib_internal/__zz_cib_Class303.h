...
struct __zz_cib_Helper<::__zz_cib_stl_helpers::vector_iterator<::PoDoFo::PdfObject*>, _T> : public __zz_cib_MethodTableHelper {
  ...
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class303::__zz_cib_methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class303::__zz_cib_classid))
  {}
