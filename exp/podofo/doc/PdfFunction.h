...
#include "__zz_cib_internal/podofo/doc/PdfFunction-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfFunction : public ::PoDoFo::PdfElement
  {
  public:
    PdfFunction(PdfFunction&& rhs);
  public:
    PdfFunction(const PdfFunction& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFunction, PoDoFo::PdfFunction);
  };
  /** This class is a PdfSampledFunction.
   */
  class PdfSampledFunction : public ::PoDoFo::PdfFunction
  {
  public:
    PdfSampledFunction(PdfSampledFunction&& rhs);
  public:
    PdfSampledFunction(const PdfSampledFunction& );
    ~PdfSampledFunction();
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfSampledFunction, PoDoFo::PdfSampledFunction);
  };
  /** This class is a PdfExponentialFunction.
   */
  class PdfExponentialFunction : public ::PoDoFo::PdfFunction
  {
  public:
    PdfExponentialFunction(PdfExponentialFunction&& rhs);
  public:
    PdfExponentialFunction(const PdfExponentialFunction& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfExponentialFunction, PoDoFo::PdfExponentialFunction);
  };
   ...
   */
  class PdfStitchingFunction : public ::PoDoFo::PdfFunction
  {
  public:
    PdfStitchingFunction(PdfStitchingFunction&& rhs);
  public:
    PdfStitchingFunction(const PdfStitchingFunction& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfStitchingFunction, PoDoFo::PdfStitchingFunction);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfFunction-postdef.h"
#endif
