...
struct __zz_cib_Helper<::PoDoFo::PdfImmediateWriter, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfImmediateWriter>);
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class376::__zz_cib_classid))
  {}
  ...
  static auto GetWriteMode_3(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetWriteMode_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto GetPdfVersion_4(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetPdfVersion_4>(
      __zz_cib_obj
      );
  }
