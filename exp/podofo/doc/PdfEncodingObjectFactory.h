...
#include "__zz_cib_internal/podofo/doc/PdfEncodingObjectFactory-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfEncodingObjectFactory(PdfEncodingObjectFactory&& rhs);
  public:
    PdfEncodingObjectFactory(const PdfEncodingObjectFactory& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfEncodingObjectFactory, PoDoFo::PdfEncodingObjectFactory);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfEncodingObjectFactory-postdef.h"
#endif
