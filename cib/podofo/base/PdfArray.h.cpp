...
template<> struct __zz_cib_Delegator<::PoDoFo::PdfArray>;
template <>
...
public:
  ...
  {}
  __zz_cib_Generic(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, const ::PoDoFo::PdfObject& var)
    : ::PoDoFo::PdfArray::PdfArray(    var)
    , __zz_cib_h_(__zz_cib_proxy)
    , __zz_cib_mtbl_helper(__zz_cib_mtbl)
  {}
  __zz_cib_Generic(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, const ::PoDoFo::PdfArray& rhs)
    : ::PoDoFo::PdfArray::PdfArray(    rhs)
    , __zz_cib_h_(__zz_cib_proxy)
    , __zz_cib_mtbl_helper(__zz_cib_mtbl)
  {}
  ...
  __ZZ_CIB_DELEGATOR_MEMBERS(__zz_cib_Generic, ::PoDoFo::PdfArray)
...
private:
  ...
  friend struct __zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfArray>;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class334::__zz_cib_Generic::__zz_cib_methodid;
};
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfArray> : public ::PoDoFo::PdfArray {
  using __zz_cib_Delegatee = __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfArray>;
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_0(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfArray>(__zz_cib_proxy, __zz_cib_mtbl);
  }
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_1(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, __zz_cib_AbiType_t<const ::PoDoFo::PdfObject&> var) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfArray>(__zz_cib_proxy, __zz_cib_mtbl,     __zz_cib_::__zz_cib_FromAbiType<const ::PoDoFo::PdfObject&>(var));
  }
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_copy_2(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, const __zz_cib_Delegatee* __zz_cib_obj) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfArray>(__zz_cib_proxy, __zz_cib_mtbl, *__zz_cib_obj);
  }
  ...
  static __zz_cib_AbiType_t<::PoDoFo::PdfObject> __zz_cib_decl front_32(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfObject>(
      __zz_cib_obj->::PoDoFo::PdfArray::front()
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::PdfObject> __zz_cib_decl front_33(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfObject>(
      __zz_cib_obj->::PoDoFo::PdfArray::front()
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::PdfObject> __zz_cib_decl back_34(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfObject>(
      __zz_cib_obj->::PoDoFo::PdfArray::back()
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::PdfObject> __zz_cib_decl back_35(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfObject>(
      __zz_cib_obj->::PoDoFo::PdfArray::back()
    );
  }
  ...
  static ::PoDoFo::PdfDataType* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class346(::PoDoFo::PdfArray* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::PoDoFo::PdfArray* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class346(::PoDoFo::PdfDataType* __zz_cib_obj) {
    return __zz_cib_DownCast<::PoDoFo::PdfArray*>(__zz_cib_obj);
  }
  static ::PoDoFo::PdfOwnedDataType* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class392(::PoDoFo::PdfArray* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::PoDoFo::PdfArray* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class392(::PoDoFo::PdfOwnedDataType* __zz_cib_obj) {
    return __zz_cib_DownCast<::PoDoFo::PdfArray*>(__zz_cib_obj);
  }
  static std::uint32_t __zz_cib_decl __zz_cib_get_class_id(::PoDoFo::PdfArray** __zz_cib_obj) {
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfArray>::__zz_cib_cast_to___zz_cib_Class346),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfArray>::__zz_cib_cast_from___zz_cib_Class346),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfArray>::__zz_cib_cast_to___zz_cib_Class392),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfArray>::__zz_cib_cast_from___zz_cib_Class392),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfArray>::__zz_cib_get_class_id),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfArray>::__zz_cib_release_proxy)
  };
