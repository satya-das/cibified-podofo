...
#include "__zz_cib_internal/podofo/doc/PdfContents-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfContents(PdfContents&& rhs);
  public:
    PdfContents(const PdfContents& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfContents, PoDoFo::PdfContents);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfContents-postdef.h"
#endif
