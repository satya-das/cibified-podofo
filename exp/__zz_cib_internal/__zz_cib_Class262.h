...
struct __zz_cib_Helper<::std::vector<::PoDoFo::PdfObject>, _T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class261::__zz_cib_Class262::__zz_cib_classid))
  {}
...
public:
  ...
  const ::PoDoFo::PdfObject* data() const {
      ...
      __zz_cib_MyHelper::data_38<__zz_cib_::__zz_cib_AbiType_t<const ::PoDoFo::PdfObject*>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
