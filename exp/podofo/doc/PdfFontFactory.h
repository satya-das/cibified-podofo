...
#include "__zz_cib_internal/podofo/doc/PdfFontFactory-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfFontFactory(PdfFontFactory&& rhs);
  public:
    PdfFontFactory(const PdfFontFactory& );
    ~PdfFontFactory();
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontFactory, PoDoFo::PdfFontFactory);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfFontFactory-postdef.h"
#endif
