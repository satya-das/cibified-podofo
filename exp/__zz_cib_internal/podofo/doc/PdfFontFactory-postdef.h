...
struct __zz_cib_Helper<::PoDoFo::PdfFontFactory, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfFontFactory>);
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class435::__zz_cib_classid))
  {}
  ...
  static auto CreateFontObject_2(_Args... __zz_cib_args) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::CreateFontObject_2>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto CreateFont_3(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::CreateFont_3>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto CreateBase14Font_4(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::CreateBase14Font_4>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto GetFontType_5(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetFontType_5>(
      __zz_cib_args...);
  }
