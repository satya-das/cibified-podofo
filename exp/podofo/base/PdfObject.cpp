...
PoDoFo::PdfObject::PdfObject(__zz_cib_AbiType h)
  : ::PoDoFo::PdfVariant(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class403(h))
  , __zz_cib_h_(h)
{
...
template <>
struct __zz_cib_Delegator<::PoDoFo::PdfObject> {
  using __zz_cib_Delegatee = ::PoDoFo::PdfObject;
  static __zz_cib_AbiType_t<void> __zz_cib_decl AfterDelayedLoad_0(::PoDoFo::PdfObject* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::EPdfDataType> eDataType) {
    __zz_cib_obj->AfterDelayedLoad(
      __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::EPdfDataType>(eDataType)
    );
  }
  static __zz_cib_AbiType_t<void> __zz_cib_decl DelayedStreamLoadImpl_1(::PoDoFo::PdfObject* __zz_cib_obj) {
    __zz_cib_obj->DelayedStreamLoadImpl();
  }
  static __zz_cib_AbiType_t<void> __zz_cib_decl Write_2(const ::PoDoFo::PdfObject* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::PdfOutputDevice*> pDevice, __zz_cib_AbiType_t<::PoDoFo::EPdfWriteMode> eWriteMode, __zz_cib_AbiType_t<const ::PoDoFo::PdfEncrypt*> pEncrypt, __zz_cib_AbiType_t<const ::PoDoFo::PdfName&> keyStop) {
    __zz_cib_obj->Write(
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl DelayedLoadImpl_3(::PoDoFo::PdfObject* __zz_cib_obj) {
    __zz_cib_obj->DelayedLoadImpl();
  }
  static void __zz_cib_decl __zz_cib_delete_4(::PoDoFo::PdfObject* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfObject>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
static const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfObject>::AfterDelayedLoad_0),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfObject>::DelayedStreamLoadImpl_1),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfObject>::Write_2),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfObject>::DelayedLoadImpl_3),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfObject>::__zz_cib_delete_4)
  };
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfObject>::__zz_cib_get_proxy_method_table() {
