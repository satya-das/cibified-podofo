...
#include "__zz_cib_internal/podofo/base/PdfFilter-predef.h"
...
namespace PoDoFo
{
  ...
  public:
    ...
    PdfOutputStream* GetStream() const;
  protected:
    /**
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFilter, PoDoFo::PdfFilter);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
  ...
  {
  public:
    PdfFilterFactory(PdfFilterFactory&& rhs);
  public:
    PdfFilterFactory(const PdfFilterFactory& );
    ~PdfFilterFactory();
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFilterFactory, PoDoFo::PdfFilterFactory);
  };
}

#include "__zz_cib_internal/podofo/base/PdfFilter-postdef.h"
#endif
