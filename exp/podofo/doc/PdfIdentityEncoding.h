...
#include "__zz_cib_internal/podofo/doc/PdfIdentityEncoding-predef.h"
...
namespace PoDoFo
{
   ...
   *  characters.
   */
  class PdfIdentityEncoding : public ::PoDoFo::PdfEncoding
  {
  public:
    PdfIdentityEncoding(PdfIdentityEncoding&& rhs);
  public:
    PdfIdentityEncoding(const PdfIdentityEncoding& );
    ~PdfIdentityEncoding();
    /** 
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfIdentityEncoding, PoDoFo::PdfIdentityEncoding);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfIdentityEncoding-postdef.h"
#endif
