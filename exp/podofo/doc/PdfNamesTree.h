...
#include "__zz_cib_internal/podofo/doc/PdfNamesTree-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfNamesTree(PdfNamesTree&& rhs);
  public:
    PdfNamesTree(const PdfNamesTree& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfNamesTree, PoDoFo::PdfNamesTree);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfNamesTree-postdef.h"
#endif
