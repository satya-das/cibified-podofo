...
template<> struct __zz_cib_Delegator<::PoDoFo::PdfIdentityEncoding>;
template <>
class __zz_cib_Generic<::PoDoFo::PdfIdentityEncoding> : public ::PoDoFo::PdfIdentityEncoding {
public:
  using __zz_cib_Proxy = __zz_cib_Proxy_t<::PoDoFo::PdfIdentityEncoding>;

  __zz_cib_Generic(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, int nFirstChar, int nLastChar, bool bAutoDelete, ::PoDoFo::PdfObject* pToUnicode)
    : ::PoDoFo::PdfIdentityEncoding::PdfIdentityEncoding(    std::move(nFirstChar),
    std::move(nLastChar),
  ...
  {}
  __zz_cib_Generic(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, const ::PoDoFo::PdfIdentityEncoding& __zz_cib_param0)
    : ::PoDoFo::PdfIdentityEncoding::PdfIdentityEncoding(    __zz_cib_param0)
    , __zz_cib_h_(__zz_cib_proxy)
    , __zz_cib_mtbl_helper(__zz_cib_mtbl)
  {}
  ...
  __ZZ_CIB_DELEGATOR_MEMBERS(__zz_cib_Generic, ::PoDoFo::PdfIdentityEncoding)
...
private:
  ...
  friend struct __zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfIdentityEncoding>;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class453::__zz_cib_Generic::__zz_cib_methodid;
};
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfIdentityEncoding> : public ::PoDoFo::PdfIdentityEncoding {
  using __zz_cib_Delegatee = __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfIdentityEncoding>;
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_copy_0(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, const __zz_cib_Delegatee* __zz_cib_obj) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfIdentityEncoding>(__zz_cib_proxy, __zz_cib_mtbl, *__zz_cib_obj);
  }
  static void __zz_cib_decl __zz_cib_delete_1(__zz_cib_Delegatee* __zz_cib_obj) {
        delete __zz_cib_obj;
  }
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_2(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, __zz_cib_AbiType_t<int> nFirstChar, __zz_cib_AbiType_t<int> nLastChar, __zz_cib_AbiType_t<bool> bAutoDelete, __zz_cib_AbiType_t<::PoDoFo::PdfObject*> pToUnicode) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfIdentityEncoding>(__zz_cib_proxy, __zz_cib_mtbl,     __zz_cib_::__zz_cib_FromAbiType<int>(nFirstChar),
  ...
  static ::PoDoFo::PdfEncoding* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class350(::PoDoFo::PdfIdentityEncoding* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::PoDoFo::PdfIdentityEncoding* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class350(::PoDoFo::PdfEncoding* __zz_cib_obj) {
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfIdentityEncoding>::__zz_cib_cast_to___zz_cib_Class350),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfIdentityEncoding>::__zz_cib_cast_from___zz_cib_Class350),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfIdentityEncoding>::__zz_cib_release_proxy)
  };
