...
#include "__zz_cib_internal/podofo/doc/PdfExtGState-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfExtGState : public ::PoDoFo::PdfElement
  {
  public:
    PdfExtGState(PdfExtGState&& rhs);
  public:
    PdfExtGState(const PdfExtGState& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfExtGState, PoDoFo::PdfExtGState);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfExtGState-postdef.h"
#endif
