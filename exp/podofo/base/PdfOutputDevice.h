...
#include "__zz_cib_internal/podofo/base/PdfOutputDevice-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfOutputDevice(PdfOutputDevice&& rhs);
  public:
    PdfOutputDevice(const PdfOutputDevice& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfOutputDevice, PoDoFo::PdfOutputDevice);
  };
#  define PRINT(device, ...)	                      \
do                                              \
{                                               \
...
#include "__zz_cib_internal/podofo/base/PdfOutputDevice-postdef.h"
#endif
