...
#include "__zz_cib_internal/podofo/doc/PdfDocument-predef.h"
...
namespace PoDoFo
{
  ...
  public:
     ...
     */
    EPdfPageMode GetPageMode() const;
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfDocument, PoDoFo::PdfDocument);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfDocument-postdef.h"
#endif
