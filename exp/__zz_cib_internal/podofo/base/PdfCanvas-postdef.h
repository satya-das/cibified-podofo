...
struct __zz_cib_Helper<::PoDoFo::PdfCanvas, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfCanvas>);
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class335::__zz_cib_classid))
  {}
  ...
  static __zz_cib_AbiType __zz_cib_new_0(::PoDoFo::PdfCanvas* __zz_cib_h_) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfCanvas*, const __zz_cib_MethodTable*);
  ...
  static auto GetProcSet_6() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetProcSet_6>(
      );
  }
  template <typename _RT, typename ..._Args>
  static auto AddColorResource_7(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::AddColorResource_7>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto AddResource_8(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::AddResource_8>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  ...
  static void __zz_cib_release_proxy(::PoDoFo::PdfCanvas* __zz_cib_obj) {
