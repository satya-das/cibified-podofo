...
#include "__zz_cib_internal/podofo/doc/PdfFontType3-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfFontType3 : public ::PoDoFo::PdfFontSimple
  {
  public:
    PdfFontType3(PdfFontType3&& rhs);
  public:
    ~PdfFontType3();
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontType3, PoDoFo::PdfFontType3);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfFontType3-postdef.h"
#endif
