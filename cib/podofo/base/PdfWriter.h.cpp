...
struct __zz_cib_Delegator<::PoDoFo::PdfWriter> : public ::PoDoFo::PdfWriter {
  ...
  static __zz_cib_AbiType_t<::PoDoFo::PdfObject*> __zz_cib_decl CreateLinearizationDictionary_31(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfObject*>(
      __zz_cib_obj->::PoDoFo::PdfWriter::CreateLinearizationDictionary()
    );
  }
};
}
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfWriter>::CreateLinearizationDictionary_31)
  };
  static const __zz_cib_MethodTable methodTable = { methodArray, 32 };
  return &methodTable;
}
}}}
