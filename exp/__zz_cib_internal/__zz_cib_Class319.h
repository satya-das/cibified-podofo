...
struct __zz_cib_Helper<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >>);
  using __zz_cib_AbiType = typename _T::__zz_cib_AbiType;
  using _ProxyClass = _T;
  friend class ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >;
  CibPoDoFo::__zz_cib_local_proxy_mgr<_ProxyClass> proxyMgr;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class319::__zz_cib_methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class319::__zz_cib_classid))
  {}
...
template<>
class bidirectional_iterator<::PoDoFo::PdfReference* const >
{
public:
  bidirectional_iterator(const bidirectional_iterator<::PoDoFo::PdfReference* const >& __zz_cib_param0)
    : __zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >(__zz_cib_MyHelper::__zz_cib_copy_0(
  ...
  bidirectional_iterator()
    : __zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >(__zz_cib_MyHelper::__zz_cib_new_2(
      ))
    {}
  ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >::reference operator*() const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >::reference>(
      __zz_cib_MyHelper::__zz_cib_OperatorMul_3<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >::reference>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >::pointer operator->() const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >::pointer>(
      __zz_cib_MyHelper::__zz_cib_OperatorArrow_4<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >::pointer>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >& operator++() {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_5<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const > operator++(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_6<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
  ...
  ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >& operator--() {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_7<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const > operator--(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_8<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(__zz_cib_param0)>(std::move(__zz_cib_param0))
      )
    );
  }
  bool operator==(const ::__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >& rhs) {
...
private:
  __ZZ_CIB_TEMPLATE_CLASS_INTERNALS(__ZZ_CIB_CLASS_NAME(bidirectional_iterator<::PoDoFo::PdfReference* const >), __ZZ_CIB_CLASS_NAME(__zz_cib_stl_helpers::bidirectional_iterator<::PoDoFo::PdfReference* const >));
};
}
