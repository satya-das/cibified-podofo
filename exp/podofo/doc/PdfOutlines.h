...
#include "__zz_cib_internal/podofo/doc/PdfOutlines-predef.h"
...
namespace PoDoFo
{
   ...
   * \see PdfDestination
   */
  class PdfOutlineItem : public ::PoDoFo::PdfElement
  {
  public:
    PdfOutlineItem(PdfOutlineItem&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfOutlineItem, PoDoFo::PdfOutlineItem);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
   ...
   *  \see PdfDocument
   */
  class PdfOutlines : public ::PoDoFo::PdfOutlineItem
  {
  public:
    PdfOutlines(PdfOutlines&& rhs);
  public:
    PdfOutlines(const PdfOutlines& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfOutlines, PoDoFo::PdfOutlines);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfOutlines-postdef.h"
#endif
