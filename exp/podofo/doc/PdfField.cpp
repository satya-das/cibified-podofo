...
PoDoFo::PdfButton::PdfButton(__zz_cib_AbiType h)
  : ::PoDoFo::PdfField(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class421(h))
  , __zz_cib_h_(h)
{}
...
PoDoFo::PdfPushButton::PdfPushButton(__zz_cib_AbiType h)
  : ::PoDoFo::PdfButton(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class422(h))
  , __zz_cib_h_(h)
{}
...
PoDoFo::PdfComboBox::PdfComboBox(__zz_cib_AbiType h)
  : ::PoDoFo::PdfListField(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class426(h))
  , __zz_cib_h_(h)
{}
