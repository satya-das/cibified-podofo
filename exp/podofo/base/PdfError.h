...
#include "__zz_cib_internal/podofo/base/PdfError-predef.h"
...
#  define PODOFO_RAISE_LOGIC_IF( x, y )	 { if (x) throw ::PoDoFo::PdfError( ePdfError_InternalLogic, __FILE__, __LINE__, y ); };
  ...
  public:
    ...
    void SetInformation(std::string pszInfo);
    void SetInformation(const wchar_t* pszInfo);

  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfErrorInfo, PoDoFo::PdfErrorInfo);
  };
...
#  define PODOFO_EXCEPTION_API_DOXYGEN	PODOFO_EXCEPTION_API(PODOFO_API)
  ...
  public:
    ...
    private:
      __ZZ_CIB_PROXY_CLASS_INTERNALS(LogMessageCallback, PoDoFo::PdfError::LogMessageCallback);
    };
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfError, PoDoFo::PdfError);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfError-postdef.h"
#endif
