...
#include "__zz_cib_internal/podofo/doc/PdfXObject-predef.h"
...
namespace PoDoFo
{
   ...
   *  \see PdfPainter
   */
  class PdfXObject : public ::PoDoFo::PdfElement,public ::PoDoFo::PdfCanvas
  {
  public:
    PdfXObject(PdfXObject&& rhs);
  public:
    PdfXObject(const PdfXObject& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfXObject, PoDoFo::PdfXObject);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfXObject-postdef.h"
#endif
