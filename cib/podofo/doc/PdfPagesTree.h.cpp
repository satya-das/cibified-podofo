...
struct __zz_cib_Delegator<::PoDoFo::PdfPagesTree> : public ::PoDoFo::PdfPagesTree {
  ...
  static ::PoDoFo::PdfElement* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class418(::PoDoFo::PdfPagesTree* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::PoDoFo::PdfPagesTree* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class418(::PoDoFo::PdfElement* __zz_cib_obj) {
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfPagesTree>::__zz_cib_cast_to___zz_cib_Class418),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfPagesTree>::__zz_cib_cast_from___zz_cib_Class418)
  };
