...
#include "__zz_cib_internal/podofo/base/PdfFileStream-predef.h"
...
namespace PoDoFo
{
   ...
   *  \see PdfFileStream
   */
  class PdfFileStream : public ::PoDoFo::PdfStream
  {
  public:
    PdfFileStream(PdfFileStream&& rhs);
  public:
    PdfFileStream(const PdfFileStream& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFileStream, PoDoFo::PdfFileStream);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfFileStream-postdef.h"
#endif
