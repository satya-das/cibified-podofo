...
#include "__zz_cib_internal/podofo/doc/PdfHintStream-predef.h"
...
namespace PoDoFo
{
  ...
  namespace NonPublic
  {
    ...
    class PdfHintStream : public ::PoDoFo::PdfElement
    {
    public:
      PdfHintStream(PdfHintStream&& rhs);
    public:
      PdfHintStream(const PdfHintStream& );
    ...
    private:
      __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfHintStream, PoDoFo::NonPublic::PdfHintStream);
    };
  }
}

#include "__zz_cib_internal/podofo/doc/PdfHintStream-postdef.h"
#endif
