...
#include "__zz_cib_internal/podofo/base/PdfCanvas-predef.h"
...
namespace PoDoFo
{
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfCanvas, PoDoFo::PdfCanvas);
  };
}

#include "__zz_cib_internal/podofo/base/PdfCanvas-postdef.h"
#endif
