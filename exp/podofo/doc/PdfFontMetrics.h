...
#include "__zz_cib_internal/podofo/doc/PdfFontMetrics-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfFontMetrics(PdfFontMetrics&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontMetrics, PoDoFo::PdfFontMetrics);
  };
  // -----------------------------------------------------
  //
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfFontMetrics-postdef.h"
#endif
