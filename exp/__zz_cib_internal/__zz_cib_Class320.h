...
struct __zz_cib_Helper<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>>);
  using __zz_cib_AbiType = typename _T::__zz_cib_AbiType;
  using _ProxyClass = _T;
  friend class ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>;
  CibPoDoFo::__zz_cib_local_proxy_mgr<_ProxyClass> proxyMgr;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class320::__zz_cib_methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class320::__zz_cib_classid))
  {}
...
template<>
class bidirectional_reverse_iterator<::PoDoFo::PdfReference*>
{
public:
  bidirectional_reverse_iterator(const bidirectional_reverse_iterator<::PoDoFo::PdfReference*>& __zz_cib_param0)
    : __zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>(__zz_cib_MyHelper::__zz_cib_copy_0(
  ...
  using pointer = ::PoDoFo::PdfReference**;
  ...
  bidirectional_reverse_iterator()
    : __zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>(__zz_cib_MyHelper::__zz_cib_new_2(
      ))
    {}
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>::reference operator*() const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>::reference>(
      __zz_cib_MyHelper::__zz_cib_OperatorMul_3<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>::reference>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>::pointer operator->() const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>::pointer>(
      __zz_cib_MyHelper::__zz_cib_OperatorArrow_4<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>::pointer>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>& operator++() {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>&>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_5<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*> operator++(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_6<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
  ...
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>& operator--() {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>&>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_7<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*> operator--(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_8<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(__zz_cib_param0)>(std::move(__zz_cib_param0))
      )
    );
  }
  bool operator==(const ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>& rhs) {
...
private:
  __ZZ_CIB_TEMPLATE_CLASS_INTERNALS(__ZZ_CIB_CLASS_NAME(bidirectional_reverse_iterator<::PoDoFo::PdfReference*>), __ZZ_CIB_CLASS_NAME(__zz_cib_stl_helpers::bidirectional_reverse_iterator<::PoDoFo::PdfReference*>));
};
}
