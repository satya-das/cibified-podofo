...
template <>
struct __zz_cib_Delegator<::PoDoFo::PdfPainter> {
  using __zz_cib_Delegatee = ::PoDoFo::PdfPainter;
  static __zz_cib_AbiType_t<void> __zz_cib_decl AddToPageResources_0(::PoDoFo::PdfPainter* __zz_cib_obj, __zz_cib_AbiType_t<const ::PoDoFo::PdfName&> rIdentifier, __zz_cib_AbiType_t<const ::PoDoFo::PdfReference&> rRef, __zz_cib_AbiType_t<const ::PoDoFo::PdfName&> rName) {
  ...
  static void __zz_cib_decl __zz_cib_delete_1(::PoDoFo::PdfPainter* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfPainter>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
static const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfPainter>::AddToPageResources_0),
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfPainter>::__zz_cib_get_proxy_method_table() {
