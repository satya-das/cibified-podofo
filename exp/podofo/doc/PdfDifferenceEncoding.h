...
#include "__zz_cib_internal/podofo/doc/PdfDifferenceEncoding-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfEncodingDifference(PdfEncodingDifference&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfEncodingDifference, PoDoFo::PdfEncodingDifference);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
   ...
   */
  class PdfDifferenceEncoding : public ::PoDoFo::PdfEncoding
  {
  public:
    PdfDifferenceEncoding(PdfDifferenceEncoding&& rhs);
  public:
    PdfDifferenceEncoding(const PdfDifferenceEncoding& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfDifferenceEncoding, PoDoFo::PdfDifferenceEncoding);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfDifferenceEncoding-postdef.h"
#endif
