...
#include "__zz_cib_internal/podofo/base/PdfObjectStreamParserObject-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfObjectStreamParserObject(PdfObjectStreamParserObject&& rhs);
  public:
    PdfObjectStreamParserObject(const PdfObjectStreamParserObject& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfObjectStreamParserObject, PoDoFo::PdfObjectStreamParserObject);
  };
}

#include "__zz_cib_internal/podofo/base/PdfObjectStreamParserObject-postdef.h"
#endif
