...
#include "__zz_cib_internal/podofo/doc/PdfTilingPattern-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfTilingPattern : public ::PoDoFo::PdfElement
  {
  public:
    PdfTilingPattern(PdfTilingPattern&& rhs);
  public:
    PdfTilingPattern(const PdfTilingPattern& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfTilingPattern, PoDoFo::PdfTilingPattern);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfTilingPattern-postdef.h"
#endif
