...
#include "__zz_cib_internal/podofo/doc/PdfSignatureField-predef.h"

namespace PoDoFo
{
  /** Signature field
   */
  class PdfSignatureField : public ::PoDoFo::PdfField
  {
  public:
    PdfSignatureField(PdfSignatureField&& rhs);
  public:
    PdfSignatureField(const PdfSignatureField& );
    ~PdfSignatureField();
  protected:
    void Init();
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfSignatureField, PoDoFo::PdfSignatureField);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfSignatureField-postdef.h"
#endif
