...
#include "__zz_cib_internal/podofo/base/PdfImmediateWriter-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfImmediateWriter(PdfImmediateWriter&& rhs);
  public:
    PdfImmediateWriter(const PdfImmediateWriter& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfImmediateWriter, PoDoFo::PdfImmediateWriter);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfImmediateWriter-postdef.h"
#endif
