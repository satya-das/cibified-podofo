...
#include "__zz_cib_internal/podofo/doc/PdfPagesTreeCache-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfPagesTreeCache(PdfPagesTreeCache&& rhs);
  public:
    PdfPagesTreeCache(const PdfPagesTreeCache& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfPagesTreeCache, PoDoFo::PdfPagesTreeCache);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfPagesTreeCache-postdef.h"
#endif
