...
PoDoFo::PdfError::LogMessageCallback::LogMessageCallback()
  : PoDoFo::PdfError::LogMessageCallback(__zz_cib_MyHelper::__zz_cib_new_0(
    this))
  {}
}
namespace __zz_cib_ {
...
class __zz_cib_Generic<::PoDoFo::PdfError::LogMessageCallback> : public ::PoDoFo::PdfError::LogMessageCallback {
  ...
  explicit __zz_cib_Generic(__zz_cib_AbiType h) : ::PoDoFo::PdfError::LogMessageCallback(h), __zz_cib_h_(h) {}
public:
  static ::PoDoFo::PdfError::LogMessageCallback* __zz_cib_from_handle(__zz_cib_AbiType h) {
    return new __zz_cib_Generic(h);
  }
  void LogMessage(::PoDoFo::ELogSeverity eLogSeverity, const wchar_t* pszPrefix, const wchar_t* pszMsg, va_list& args) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(eLogSeverity)>, __zz_cib_AbiType_t<decltype(pszPrefix)>, __zz_cib_AbiType_t<decltype(pszMsg)>, __zz_cib_AbiType_t<decltype(args)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::LogMessage_3>(
      __zz_cib_h_,
  ...
  void LogMessage(::PoDoFo::ELogSeverity eLogSeverity, const char* pszPrefix, const char* pszMsg, va_list& args) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(eLogSeverity)>, __zz_cib_AbiType_t<decltype(pszPrefix)>, __zz_cib_AbiType_t<decltype(pszMsg)>, __zz_cib_AbiType_t<decltype(args)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::LogMessage_2>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(eLogSeverity)>(std::move(eLogSeverity)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(pszPrefix)>(std::move(pszPrefix)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(pszMsg)>(std::move(pszMsg)),
...
namespace __zz_cib_ {
template<>
::PoDoFo::PdfError::LogMessageCallback* __zz_cib_Helper<::PoDoFo::PdfError::LogMessageCallback>::__zz_cib_create_proxy(__zz_cib_AbiType h) {
  switch(__zz_cib_get_class_id(&h)) {
  default: break;
  }
  return ::__zz_cib_::__zz_cib_Generic<::PoDoFo::PdfError::LogMessageCallback>::__zz_cib_from_handle(h);
}
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfError::LogMessageCallback> {
  ...
  static void __zz_cib_decl __zz_cib_delete_2(::PoDoFo::PdfError::LogMessageCallback* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfError::LogMessageCallback>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfError::LogMessageCallback>::__zz_cib_get_proxy_method_table() {
