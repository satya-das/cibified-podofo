...
#include "__zz_cib_internal/podofo/doc/PdfFontMetricsFreetype-predef.h"
...
namespace PoDoFo
{
  ...
  class PdfObject;
  class PdfVariant;
  class PdfFontMetricsFreetype : public ::PoDoFo::PdfFontMetrics
  {
  public:
    PdfFontMetricsFreetype(PdfFontMetricsFreetype&& rhs);
  public:
    PdfFontMetricsFreetype(const PdfFontMetricsFreetype& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontMetricsFreetype, PoDoFo::PdfFontMetricsFreetype);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfFontMetricsFreetype-postdef.h"
#endif
