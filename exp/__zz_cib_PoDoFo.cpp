...
__zz_cib_Helper()
  : __zz_cib_MethodTableHelper(
    __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_classid))
{}
...
static __zz_cib_MethodTableHelper& __zz_cib_mtbl() {
  ...
  static auto PdfLocaleImbue_0(_Args... __zz_cib_args) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PdfLocaleImbue_0>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto podofo_malloc_1(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::podofo_malloc_1>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto podofo_calloc_2(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::podofo_calloc_2>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto podofo_realloc_3(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::podofo_realloc_3>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto podofo_free_4(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::podofo_free_4>(
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto podofo_is_little_endian_5() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::podofo_is_little_endian_5>(
      );
  }
  template <typename _RT, typename ..._Args>
  static auto SetAppearanceStreamForObject_6(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::SetAppearanceStreamForObject_6>(
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto PODOFO_Base14FontDef_FindBuiltinData_7(_Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (_Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PODOFO_Base14FontDef_FindBuiltinData_7>(
      __zz_cib_args...);
  }
};
}}
