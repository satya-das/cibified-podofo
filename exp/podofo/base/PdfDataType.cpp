...
PoDoFo::PdfDataType::PdfDataType()
  : PoDoFo::PdfDataType(__zz_cib_MyHelper::__zz_cib_new_0(
    this))
  {}
...
struct __zz_cib_Delegator<::PoDoFo::PdfDataType> {
  ...
  static void __zz_cib_decl __zz_cib_delete_3(::PoDoFo::PdfDataType* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfDataType>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfDataType>::__zz_cib_get_proxy_method_table() {
