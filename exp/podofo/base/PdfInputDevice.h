...
#include "__zz_cib_internal/podofo/base/PdfInputDevice-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfInputDevice(PdfInputDevice&& rhs);
  public:
    PdfInputDevice(const PdfInputDevice& );
     ...
     * and failbit.
     */
    virtual void Clear(std::ios_base::iostate state = std::ios_base::goodbit) const;
    /**
  ...
  protected:
     ...
     * seekable.
     */
    void SetSeekable(bool bIsSeekable);
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfInputDevice, PoDoFo::PdfInputDevice);
  };
}

#include "__zz_cib_internal/podofo/base/PdfInputDevice-postdef.h"
#endif
