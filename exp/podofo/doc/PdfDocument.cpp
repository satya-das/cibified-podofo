...
class __zz_cib_Generic<::PoDoFo::PdfDocument> : public ::PoDoFo::PdfDocument {
  ...
  explicit __zz_cib_Generic(__zz_cib_AbiType h) : ::PoDoFo::PdfDocument(h), __zz_cib_h_(h) {}
public:
  static ::PoDoFo::PdfDocument* __zz_cib_from_handle(__zz_cib_AbiType h) {
  ...
  bool IsDocAssemblyAllowed() const override {
    ...
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsDocAssemblyAllowed_49>(
        __zz_cib_h_
      )
    );
  }
  bool IsHighPrintAllowed() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsHighPrintAllowed_50>(
        __zz_cib_h_
      )
    );
  }
  bool IsFillAndSignAllowed() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsFillAndSignAllowed_47>(
        __zz_cib_h_
      )
    );
  }
  bool IsEditNotesAllowed() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsEditNotesAllowed_46>(
        __zz_cib_h_
      )
    );
  }
  ::PoDoFo::EPdfVersion GetPdfVersion() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::EPdfVersion>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<::PoDoFo::EPdfVersion>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetPdfVersion_2>(
        __zz_cib_h_
      )
    );
  }
  ::PoDoFo::EPdfWriteMode GetWriteMode() const override {
    ...
    return __zz_cib_FromAbiType<::PoDoFo::EPdfWriteMode>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetWriteMode_1>(
        __zz_cib_h_
      )
    );
  }
  bool IsLinearized() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsLinearized_3>(
        __zz_cib_h_
      )
    );
  }
  bool IsCopyAllowed() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsCopyAllowed_45>(
        __zz_cib_h_
      )
    );
  }
  bool IsPrintAllowed() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsPrintAllowed_43>(
        __zz_cib_h_
      )
    );
  }
  bool IsAccessibilityAllowed() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsAccessibilityAllowed_48>(
        __zz_cib_h_
      )
    );
  }
  bool IsEditAllowed() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::IsEditAllowed_44>(
        __zz_cib_h_
      )
    );
  }
...
namespace __zz_cib_ {
template<>
::PoDoFo::PdfDocument* __zz_cib_Helper<::PoDoFo::PdfDocument>::__zz_cib_create_proxy(__zz_cib_AbiType h) {
  switch(__zz_cib_get_class_id(&h)) {
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class456::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfMemDocument>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfMemDocument>::__zz_cib_cast_from___zz_cib_Class417(h)
    );
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class473::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfStreamedDocument>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfStreamedDocument>::__zz_cib_cast_from___zz_cib_Class417(h)
    );
  default: break;
  }
  return ::__zz_cib_::__zz_cib_Generic<::PoDoFo::PdfDocument>::__zz_cib_from_handle(h);
}
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfDocument> {
  ...
  static void __zz_cib_decl __zz_cib_delete_11(::PoDoFo::PdfDocument* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfDocument>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfDocument>::__zz_cib_get_proxy_method_table() {
