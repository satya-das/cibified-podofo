...
struct __zz_cib_Helper<::PoDoFo::PdfEncodingFactory, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfEncodingFactory>);
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class362::__zz_cib_classid))
  {}
  ...
  static auto GlobalPdfDocEncodingInstance_2() {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalPdfDocEncodingInstance_2>(
      );
  }
  template <typename _RT>
  static auto GlobalWinAnsiEncodingInstance_3() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalWinAnsiEncodingInstance_3>(
      );
  }
  template <typename _RT>
  static auto GlobalMacRomanEncodingInstance_4() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalMacRomanEncodingInstance_4>(
      );
  }
  template <typename _RT>
  static auto GlobalStandardEncodingInstance_5() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalStandardEncodingInstance_5>(
      );
  }
  template <typename _RT>
  static auto GlobalMacExpertEncodingInstance_6() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalMacExpertEncodingInstance_6>(
      );
  }
  template <typename _RT>
  static auto GlobalSymbolEncodingInstance_7() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalSymbolEncodingInstance_7>(
      );
  }
  template <typename _RT>
  static auto GlobalZapfDingbatsEncodingInstance_8() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalZapfDingbatsEncodingInstance_8>(
      );
  }
  template <typename _RT>
  static auto GlobalIdentityEncodingInstance_9() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalIdentityEncodingInstance_9>(
      );
  }
  template <typename _RT>
  static auto GlobalWin1250EncodingInstance_10() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalWin1250EncodingInstance_10>(
      );
  }
  template <typename _RT>
  static auto GlobalIso88592EncodingInstance_11() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GlobalIso88592EncodingInstance_11>(
      );
  }
  template <typename _RT>
  static auto FreeGlobalEncodingInstances_12() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::FreeGlobalEncodingInstances_12>(
      );
  }
  template <typename _RT>
  static auto PoDoFoClientAttached_13() {
    using __zz_cib_proc = _RT (__zz_cib_decl *) ();
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PoDoFoClientAttached_13>(
      );
  }
