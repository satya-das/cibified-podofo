...
PoDoFo::PdfEncrypt::PdfEncrypt()
  : PoDoFo::PdfEncrypt(__zz_cib_MyHelper::__zz_cib_new_33(
    this))
  {}
...
PoDoFo::PdfEncryptMD5Base::PdfEncryptMD5Base(__zz_cib_AbiType h)
  : ::PoDoFo::PdfEncrypt(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class363(h))
  , ::PoDoFo::PdfEncryptRC4Base(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class365(h))
  , __zz_cib_h_(h)
{
  __zz_cib_MyHelper::__zz_cib_add_proxy(this, __zz_cib_h_);
}
...
PoDoFo::PdfEncryptMD5Base::PdfEncryptMD5Base()
  : PoDoFo::PdfEncryptMD5Base(__zz_cib_MyHelper::__zz_cib_new_0(
    this))
  {}
...
PoDoFo::PdfEncryptAESV2::PdfEncryptAESV2(__zz_cib_AbiType h)
  : ::PoDoFo::PdfEncryptMD5Base(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class366(h))
  , ::PoDoFo::PdfEncryptAESBase(__zz_cib_MyHelper::__zz_cib_cast_to___zz_cib_Class364(h))
  , __zz_cib_h_(h)
{
  __zz_cib_MyHelper::__zz_cib_add_proxy(this, __zz_cib_h_);
}
...
class __zz_cib_Generic<::PoDoFo::PdfEncrypt> : public ::PoDoFo::PdfEncrypt {
  ...
  explicit __zz_cib_Generic(__zz_cib_AbiType h) : ::PoDoFo::PdfEncrypt(h), __zz_cib_h_(h) {}
public:
  static ::PoDoFo::PdfEncrypt* __zz_cib_from_handle(__zz_cib_AbiType h) {
    return new __zz_cib_Generic(h);
  }
  ::PoDoFo::pdf_long CalculateStreamLength(::PoDoFo::pdf_long length) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::pdf_long>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(length)>);
    return __zz_cib_FromAbiType<::PoDoFo::pdf_long>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CalculateStreamLength_30>(
        __zz_cib_h_,
        __zz_cib_::__zz_cib_ToAbiType<decltype(length)>(std::move(length))
      )
    );
  ...
  void Decrypt(const unsigned char* inStr, ::PoDoFo::pdf_long inLen, unsigned char* outStr, ::PoDoFo::pdf_long& outLen) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(inStr)>, __zz_cib_AbiType_t<decltype(inLen)>, __zz_cib_AbiType_t<decltype(outStr)>, __zz_cib_AbiType_t<decltype(outLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Decrypt_29>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(inStr)>(std::move(inStr)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(inLen)>(std::move(inLen)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(outStr)>(std::move(outStr)),
  ...
  void Encrypt(const unsigned char* inStr, ::PoDoFo::pdf_long inLen, unsigned char* outStr, ::PoDoFo::pdf_long outLen) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(inStr)>, __zz_cib_AbiType_t<decltype(inLen)>, __zz_cib_AbiType_t<decltype(outStr)>, __zz_cib_AbiType_t<decltype(outLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Encrypt_28>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(inStr)>(std::move(inStr)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(inLen)>(std::move(inLen)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(outStr)>(std::move(outStr)),
  ...
  void GenerateEncryptionKey(const ::PoDoFo::PdfString& documentId) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(documentId)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GenerateEncryptionKey_7>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(documentId)>(documentId)
    );
  }
  ::PoDoFo::pdf_long CalculateStreamOffset() const override {
    ...
    return __zz_cib_FromAbiType<::PoDoFo::pdf_long>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CalculateStreamOffset_31>(
        __zz_cib_h_
      )
    );
  }
  bool Authenticate(const std::string& password, const ::PoDoFo::PdfString& documentId) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(password)>, __zz_cib_AbiType_t<decltype(documentId)>);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Authenticate_11>(
        __zz_cib_h_,
        __zz_cib_::__zz_cib_ToAbiType<decltype(password)>(password),
        __zz_cib_::__zz_cib_ToAbiType<decltype(documentId)>(documentId)
      )
  ...
  void CreateEncryptionDictionary(::PoDoFo::PdfDictionary& rDictionary) const override {
    ...
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateEncryptionDictionary_8>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(rDictionary)>(rDictionary)
    );
  }
  ::PoDoFo::PdfOutputStream* CreateEncryptionOutputStream(::PoDoFo::PdfOutputStream* pOutputStream) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::PdfOutputStream*>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pOutputStream)>);
    return __zz_cib_FromAbiType<::PoDoFo::PdfOutputStream*>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateEncryptionOutputStream_9>(
        __zz_cib_h_,
        __zz_cib_::__zz_cib_ToAbiType<decltype(pOutputStream)>(std::move(pOutputStream))
      )
    );
  ...
  ::PoDoFo::PdfInputStream* CreateEncryptionInputStream(::PoDoFo::PdfInputStream* pInputStream) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::PdfInputStream*>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pInputStream)>);
    return __zz_cib_FromAbiType<::PoDoFo::PdfInputStream*>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateEncryptionInputStream_10>(
        __zz_cib_h_,
        __zz_cib_::__zz_cib_ToAbiType<decltype(pInputStream)>(std::move(pInputStream))
      )
    );
...
namespace __zz_cib_ {
template<>
::PoDoFo::PdfEncrypt* __zz_cib_Helper<::PoDoFo::PdfEncrypt>::__zz_cib_create_proxy(__zz_cib_AbiType h) {
  switch(__zz_cib_get_class_id(&h)) {
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class367::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfEncryptAESV2>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfEncryptAESV2>::__zz_cib_cast_from___zz_cib_Class363(h)
    );
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class368::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfEncryptRC4>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfEncryptRC4>::__zz_cib_cast_from___zz_cib_Class363(h)
    );
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class366::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfEncryptMD5Base>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfEncryptMD5Base>::__zz_cib_cast_from___zz_cib_Class363(h)
    );
  default: break;
  }
  return ::__zz_cib_::__zz_cib_Generic<::PoDoFo::PdfEncrypt>::__zz_cib_from_handle(h);
}
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfEncrypt> {
  ...
  static void __zz_cib_decl __zz_cib_delete_4(::PoDoFo::PdfEncrypt* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfEncrypt>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfEncrypt>::__zz_cib_get_proxy_method_table() {
...
class __zz_cib_Generic<::PoDoFo::PdfEncryptMD5Base> : public ::PoDoFo::PdfEncryptMD5Base {
  ...
  explicit __zz_cib_Generic(__zz_cib_AbiType h) : ::PoDoFo::PdfEncryptMD5Base(h), __zz_cib_h_(h) {}
public:
  static ::PoDoFo::PdfEncryptMD5Base* __zz_cib_from_handle(__zz_cib_AbiType h) {
    return new __zz_cib_Generic(h);
  }
  void GenerateInitialVector(unsigned char iv[16]) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(iv)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GenerateInitialVector_14>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(iv)>(std::move(iv))
    );
  }
  ::PoDoFo::pdf_long CalculateStreamLength(::PoDoFo::pdf_long length) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::pdf_long>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(length)>);
    return __zz_cib_FromAbiType<::PoDoFo::pdf_long>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CalculateStreamLength_11>(
        __zz_cib_h_,
        __zz_cib_::__zz_cib_ToAbiType<decltype(length)>(std::move(length))
      )
    );
  ...
  void Decrypt(const unsigned char* inStr, ::PoDoFo::pdf_long inLen, unsigned char* outStr, ::PoDoFo::pdf_long& outLen) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(inStr)>, __zz_cib_AbiType_t<decltype(inLen)>, __zz_cib_AbiType_t<decltype(outStr)>, __zz_cib_AbiType_t<decltype(outLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Decrypt_19>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(inStr)>(std::move(inStr)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(inLen)>(std::move(inLen)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(outStr)>(std::move(outStr)),
  ...
  void CreateEncryptionDictionary(::PoDoFo::PdfDictionary& rDictionary) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(rDictionary)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateEncryptionDictionary_5>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(rDictionary)>(rDictionary)
    );
  }
  void GenerateEncryptionKey(const ::PoDoFo::PdfString& documentId) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(documentId)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GenerateEncryptionKey_8>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(documentId)>(documentId)
    );
  }
  ::PoDoFo::pdf_long CalculateStreamOffset() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::pdf_long>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<::PoDoFo::pdf_long>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CalculateStreamOffset_10>(
        __zz_cib_h_
      )
    );
  }
  ...
  ::PoDoFo::PdfOutputStream* CreateEncryptionOutputStream(::PoDoFo::PdfOutputStream* pOutputStream) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::PdfOutputStream*>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pOutputStream)>);
    return __zz_cib_FromAbiType<::PoDoFo::PdfOutputStream*>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateEncryptionOutputStream_4>(
        __zz_cib_h_,
        __zz_cib_::__zz_cib_ToAbiType<decltype(pOutputStream)>(std::move(pOutputStream))
      )
    );
  ...
  void CreateObjKey(unsigned char objkey[16], int* pnKeyLen) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(objkey)>, __zz_cib_AbiType_t<decltype(pnKeyLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateObjKey_18>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(objkey)>(std::move(objkey)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(pnKeyLen)>(std::move(pnKeyLen))
    );
  ...
  ::PoDoFo::PdfInputStream* CreateEncryptionInputStream(::PoDoFo::PdfInputStream* pInputStream) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::PdfInputStream*>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pInputStream)>);
    return __zz_cib_FromAbiType<::PoDoFo::PdfInputStream*>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateEncryptionInputStream_3>(
        __zz_cib_h_,
        __zz_cib_::__zz_cib_ToAbiType<decltype(pInputStream)>(std::move(pInputStream))
      )
    );
  ...
  void Encrypt(const unsigned char* inStr, ::PoDoFo::pdf_long inLen, unsigned char* outStr, ::PoDoFo::pdf_long outLen) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(inStr)>, __zz_cib_AbiType_t<decltype(inLen)>, __zz_cib_AbiType_t<decltype(outStr)>, __zz_cib_AbiType_t<decltype(outLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Encrypt_7>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(inStr)>(std::move(inStr)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(inLen)>(std::move(inLen)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(outStr)>(std::move(outStr)),
...
namespace __zz_cib_ {
template<>
::PoDoFo::PdfEncryptMD5Base* __zz_cib_Helper<::PoDoFo::PdfEncryptMD5Base>::__zz_cib_create_proxy(__zz_cib_AbiType h) {
  switch(__zz_cib_get_class_id(&h)) {
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class367::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfEncryptAESV2>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfEncryptAESV2>::__zz_cib_cast_from___zz_cib_Class366(h)
    );
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class368::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfEncryptRC4>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfEncryptRC4>::__zz_cib_cast_from___zz_cib_Class366(h)
    );
  default: break;
  }
  return ::__zz_cib_::__zz_cib_Generic<::PoDoFo::PdfEncryptMD5Base>::__zz_cib_from_handle(h);
}
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfEncryptMD5Base> {
  ...
  static void __zz_cib_decl __zz_cib_delete_11(::PoDoFo::PdfEncryptMD5Base* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfEncryptMD5Base>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfEncryptMD5Base>::__zz_cib_get_proxy_method_table() {
...
using namespace ::PoDoFo;
template <>
struct __zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2> {
  using __zz_cib_Delegatee = ::PoDoFo::PdfEncryptAESV2;
  static __zz_cib_AbiType_t<void> __zz_cib_decl GenerateInitialVector_0(::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<unsigned char[16]> iv) {
    __zz_cib_obj->GenerateInitialVector(
      __zz_cib_::__zz_cib_FromAbiType<unsigned char[16]>(iv)
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::pdf_long> __zz_cib_decl CalculateStreamLength_1(const ::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::pdf_long> length) {
    return __zz_cib_ToAbiType<::PoDoFo::pdf_long>(
      __zz_cib_obj->CalculateStreamLength(
        __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::pdf_long>(length)
      )
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl Decrypt_2(const ::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<const unsigned char*> inStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long> inLen, __zz_cib_AbiType_t<unsigned char*> outStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long&> outLen) {
    __zz_cib_obj->Decrypt(
      __zz_cib_::__zz_cib_FromAbiType<const unsigned char*>(inStr),
      __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::pdf_long>(inLen),
      __zz_cib_::__zz_cib_FromAbiType<unsigned char*>(outStr),
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl CreateEncryptionDictionary_3(const ::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::PdfDictionary&> rDictionary) {
    __zz_cib_obj->CreateEncryptionDictionary(
      __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::PdfDictionary&>(rDictionary)
    );
  }
  static __zz_cib_AbiType_t<void> __zz_cib_decl GenerateEncryptionKey_4(::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<const ::PoDoFo::PdfString&> documentId) {
    __zz_cib_obj->GenerateEncryptionKey(
      __zz_cib_::__zz_cib_FromAbiType<const ::PoDoFo::PdfString&>(documentId)
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::pdf_long> __zz_cib_decl CalculateStreamOffset_5(const ::PoDoFo::PdfEncryptAESV2* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::PoDoFo::pdf_long>(
      __zz_cib_obj->CalculateStreamOffset()
    );
  }
  static __zz_cib_AbiType_t<bool> __zz_cib_decl Authenticate_6(::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<const std::string&> password, __zz_cib_AbiType_t<const ::PoDoFo::PdfString&> documentId) {
    return __zz_cib_ToAbiType<bool>(
      __zz_cib_obj->Authenticate(
        __zz_cib_::__zz_cib_FromAbiType<const std::string&>(password),
        __zz_cib_::__zz_cib_FromAbiType<const ::PoDoFo::PdfString&>(documentId)
  ...
  static __zz_cib_AbiType_t<::PoDoFo::PdfOutputStream*> __zz_cib_decl CreateEncryptionOutputStream_7(::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::PdfOutputStream*> pOutputStream) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfOutputStream*>(
      __zz_cib_obj->CreateEncryptionOutputStream(
        __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::PdfOutputStream*>(pOutputStream)
      )
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl CreateObjKey_8(const ::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<unsigned char[16]> objkey, __zz_cib_AbiType_t<int*> pnKeyLen) {
    __zz_cib_obj->CreateObjKey(
      __zz_cib_::__zz_cib_FromAbiType<unsigned char[16]>(objkey),
      __zz_cib_::__zz_cib_FromAbiType<int*>(pnKeyLen)
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::PdfInputStream*> __zz_cib_decl CreateEncryptionInputStream_9(::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::PdfInputStream*> pInputStream) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfInputStream*>(
      __zz_cib_obj->CreateEncryptionInputStream(
        __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::PdfInputStream*>(pInputStream)
      )
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl Encrypt_10(const ::PoDoFo::PdfEncryptAESV2* __zz_cib_obj, __zz_cib_AbiType_t<const unsigned char*> inStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long> inLen, __zz_cib_AbiType_t<unsigned char*> outStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long> outLen) {
    __zz_cib_obj->Encrypt(
      __zz_cib_::__zz_cib_FromAbiType<const unsigned char*>(inStr),
      __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::pdf_long>(inLen),
      __zz_cib_::__zz_cib_FromAbiType<unsigned char*>(outStr),
  ...
  static void __zz_cib_decl __zz_cib_delete_11(::PoDoFo::PdfEncryptAESV2* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfEncryptAESV2>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
static const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::GenerateInitialVector_0),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::CalculateStreamLength_1),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::Decrypt_2),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::CreateEncryptionDictionary_3),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::GenerateEncryptionKey_4),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::CalculateStreamOffset_5),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::Authenticate_6),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::CreateEncryptionOutputStream_7),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::CreateObjKey_8),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::CreateEncryptionInputStream_9),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::Encrypt_10),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptAESV2>::__zz_cib_delete_11)
  };
  static const __zz_cib_MethodTable methodTable = { methodArray, 12 };
  return &methodTable;
}
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfEncryptAESV2>::__zz_cib_get_proxy_method_table() {
...
using namespace ::PoDoFo;
template <>
struct __zz_cib_Delegator<::PoDoFo::PdfEncryptRC4> {
  using __zz_cib_Delegatee = ::PoDoFo::PdfEncryptRC4;
  static __zz_cib_AbiType_t<void> __zz_cib_decl GenerateInitialVector_0(::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<unsigned char[16]> iv) {
    __zz_cib_obj->GenerateInitialVector(
      __zz_cib_::__zz_cib_FromAbiType<unsigned char[16]>(iv)
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::pdf_long> __zz_cib_decl CalculateStreamLength_1(const ::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::pdf_long> length) {
    return __zz_cib_ToAbiType<::PoDoFo::pdf_long>(
      __zz_cib_obj->CalculateStreamLength(
        __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::pdf_long>(length)
      )
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl Decrypt_2(const ::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<const unsigned char*> inStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long> inLen, __zz_cib_AbiType_t<unsigned char*> outStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long&> outLen) {
    __zz_cib_obj->Decrypt(
      __zz_cib_::__zz_cib_FromAbiType<const unsigned char*>(inStr),
      __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::pdf_long>(inLen),
      __zz_cib_::__zz_cib_FromAbiType<unsigned char*>(outStr),
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl CreateEncryptionDictionary_3(const ::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::PdfDictionary&> rDictionary) {
    __zz_cib_obj->CreateEncryptionDictionary(
      __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::PdfDictionary&>(rDictionary)
    );
  }
  static __zz_cib_AbiType_t<void> __zz_cib_decl GenerateEncryptionKey_4(::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<const ::PoDoFo::PdfString&> documentId) {
    __zz_cib_obj->GenerateEncryptionKey(
      __zz_cib_::__zz_cib_FromAbiType<const ::PoDoFo::PdfString&>(documentId)
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::pdf_long> __zz_cib_decl CalculateStreamOffset_5(const ::PoDoFo::PdfEncryptRC4* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::PoDoFo::pdf_long>(
      __zz_cib_obj->CalculateStreamOffset()
    );
  }
  static __zz_cib_AbiType_t<bool> __zz_cib_decl Authenticate_6(::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<const std::string&> password, __zz_cib_AbiType_t<const ::PoDoFo::PdfString&> documentId) {
    return __zz_cib_ToAbiType<bool>(
      __zz_cib_obj->Authenticate(
        __zz_cib_::__zz_cib_FromAbiType<const std::string&>(password),
        __zz_cib_::__zz_cib_FromAbiType<const ::PoDoFo::PdfString&>(documentId)
  ...
  static __zz_cib_AbiType_t<::PoDoFo::PdfOutputStream*> __zz_cib_decl CreateEncryptionOutputStream_7(::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::PdfOutputStream*> pOutputStream) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfOutputStream*>(
      __zz_cib_obj->CreateEncryptionOutputStream(
        __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::PdfOutputStream*>(pOutputStream)
      )
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl CreateObjKey_8(const ::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<unsigned char[16]> objkey, __zz_cib_AbiType_t<int*> pnKeyLen) {
    __zz_cib_obj->CreateObjKey(
      __zz_cib_::__zz_cib_FromAbiType<unsigned char[16]>(objkey),
      __zz_cib_::__zz_cib_FromAbiType<int*>(pnKeyLen)
    );
  }
  static __zz_cib_AbiType_t<::PoDoFo::PdfInputStream*> __zz_cib_decl CreateEncryptionInputStream_9(::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<::PoDoFo::PdfInputStream*> pInputStream) {
    return __zz_cib_ToAbiType<::PoDoFo::PdfInputStream*>(
      __zz_cib_obj->CreateEncryptionInputStream(
        __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::PdfInputStream*>(pInputStream)
      )
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl Encrypt_10(const ::PoDoFo::PdfEncryptRC4* __zz_cib_obj, __zz_cib_AbiType_t<const unsigned char*> inStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long> inLen, __zz_cib_AbiType_t<unsigned char*> outStr, __zz_cib_AbiType_t<::PoDoFo::pdf_long> outLen) {
    __zz_cib_obj->Encrypt(
      __zz_cib_::__zz_cib_FromAbiType<const unsigned char*>(inStr),
      __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::pdf_long>(inLen),
      __zz_cib_::__zz_cib_FromAbiType<unsigned char*>(outStr),
  ...
  static void __zz_cib_decl __zz_cib_delete_11(::PoDoFo::PdfEncryptRC4* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfEncryptRC4>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
static const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::GenerateInitialVector_0),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::CalculateStreamLength_1),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::Decrypt_2),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::CreateEncryptionDictionary_3),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::GenerateEncryptionKey_4),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::CalculateStreamOffset_5),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::Authenticate_6),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::CreateEncryptionOutputStream_7),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::CreateObjKey_8),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::CreateEncryptionInputStream_9),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::Encrypt_10),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfEncryptRC4>::__zz_cib_delete_11)
  };
  static const __zz_cib_MethodTable methodTable = { methodArray, 12 };
  return &methodTable;
}
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfEncryptRC4>::__zz_cib_get_proxy_method_table() {
