...
#include "__zz_cib_internal/podofo/base/PdfParser-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfParser : public ::PoDoFo::PdfTokenizer
  {
  public:
    PdfParser(PdfParser&& rhs);
  public:
    struct TXRefEntry
    {
    public:
      TXRefEntry(TXRefEntry&& rhs);
    public:
      TXRefEntry(const TXRefEntry& );
      ~TXRefEntry();
        TXRefEntry();

      private:
        __ZZ_CIB_PROXY_CLASS_INTERNALS(TXRefEntry, PoDoFo::PdfParser::TXRefEntry);
      };
...
#  endif
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfParser, PoDoFo::PdfParser);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfParser-postdef.h"
#endif
