...
template<> struct __zz_cib_Delegator<::PoDoFo::PdfPainter>;
template <>
class __zz_cib_Generic<::PoDoFo::PdfPainter> : public ::PoDoFo::PdfPainter {
public:
  using __zz_cib_Proxy = __zz_cib_Proxy_t<::PoDoFo::PdfPainter>;
  ...
  __ZZ_CIB_DELEGATOR_MEMBERS(__zz_cib_Generic, ::PoDoFo::PdfPainter)
...
private:
  ...
  friend struct __zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfPainter>;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class464::__zz_cib_Generic::__zz_cib_methodid;
};
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfPainter> : public ::PoDoFo::PdfPainter {
  using __zz_cib_Delegatee = __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfPainter>;
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_0(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfPainter>(__zz_cib_proxy, __zz_cib_mtbl);
  }
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfPainter>::__zz_cib_release_proxy)
  };
  static const __zz_cib_MethodTable methodTable = { methodArray, 87 };
  return &methodTable;
}
}}}
