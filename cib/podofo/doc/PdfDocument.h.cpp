...
public:
  ...
  __zz_cib_Generic(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, bool bEmpty)
...
struct __zz_cib_Delegator<::PoDoFo::PdfDocument> : public ::PoDoFo::PdfDocument {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_54(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl, __zz_cib_AbiType_t<bool> bEmpty) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfDocument>(__zz_cib_proxy, __zz_cib_mtbl,     __zz_cib_::__zz_cib_FromAbiType<bool>(bEmpty));
  }
  ...
  static std::uint32_t __zz_cib_decl __zz_cib_get_class_id(::PoDoFo::PdfDocument** __zz_cib_obj) {
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfDocument>::__zz_cib_get_class_id),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfDocument>::__zz_cib_release_proxy)
  };
