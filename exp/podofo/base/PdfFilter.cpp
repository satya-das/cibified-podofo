...
PoDoFo::PdfFilter::PdfFilter()
  : PoDoFo::PdfFilter(__zz_cib_MyHelper::__zz_cib_new_0(
    this))
  {}
...
class __zz_cib_Generic<::PoDoFo::PdfFilter> : public ::PoDoFo::PdfFilter {
  ...
  explicit __zz_cib_Generic(__zz_cib_AbiType h) : ::PoDoFo::PdfFilter(h), __zz_cib_h_(h) {}
public:
  static ::PoDoFo::PdfFilter* __zz_cib_from_handle(__zz_cib_AbiType h) {
  ...
  void DecodeBlockImpl(const char* pBuffer, ::PoDoFo::pdf_long lLen) override {
    ...
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::DecodeBlockImpl_19>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(pBuffer)>(std::move(pBuffer)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(lLen)>(std::move(lLen))
    );
  ...
  void EndDecodeImpl() override {
    ...
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::EndDecodeImpl_20>(
      __zz_cib_h_
    );
  }
  bool CanDecode() const override {
    ...
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CanDecode_7>(
        __zz_cib_h_
      )
    );
  }
  bool CanEncode() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<bool>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<bool>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CanEncode_2>(
        __zz_cib_h_
      )
    );
  }
  ::PoDoFo::EPdfFilter GetType() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::EPdfFilter>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<::PoDoFo::EPdfFilter>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetType_12>(
        __zz_cib_h_
      )
    );
  }
  void BeginDecodeImpl(const ::PoDoFo::PdfDictionary* __zz_cib_param0) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(__zz_cib_param0)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::BeginDecodeImpl_18>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(__zz_cib_param0)>(std::move(__zz_cib_param0))
    );
  }
  void BeginEncodeImpl() override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::BeginEncodeImpl_15>(
      __zz_cib_h_
    );
  }
  void EncodeBlockImpl(const char* pBuffer, ::PoDoFo::pdf_long lLen) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pBuffer)>, __zz_cib_AbiType_t<decltype(lLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::EncodeBlockImpl_16>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(pBuffer)>(std::move(pBuffer)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(lLen)>(std::move(lLen))
    );
  ...
  void EndEncodeImpl() override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::EndEncodeImpl_17>(
      __zz_cib_h_
    );
  }
};
...
namespace __zz_cib_ {
template<>
::PoDoFo::PdfFilter* __zz_cib_Helper<::PoDoFo::PdfFilter>::__zz_cib_create_proxy(__zz_cib_AbiType h) {
  switch(__zz_cib_get_class_id(&h)) {
  default: break;
  }
  return ::__zz_cib_::__zz_cib_Generic<::PoDoFo::PdfFilter>::__zz_cib_from_handle(h);
}
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfFilter> {
  ...
  static void __zz_cib_decl __zz_cib_delete_9(::PoDoFo::PdfFilter* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfFilter>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfFilter>::__zz_cib_get_proxy_method_table() {
