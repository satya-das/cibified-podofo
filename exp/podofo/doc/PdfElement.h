...
#include "__zz_cib_internal/podofo/doc/PdfElement-predef.h"
...
namespace PoDoFo
{
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfElement, PoDoFo::PdfElement);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfElement-postdef.h"
#endif
