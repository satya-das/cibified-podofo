...
#include "__zz_cib_internal/podofo/doc/PdfCMapEncoding-predef.h"

namespace PoDoFo
{
  class PdfCMapEncoding : public ::PoDoFo::PdfEncoding
  {
  public:
    PdfCMapEncoding(PdfCMapEncoding&& rhs);
  public:
    PdfCMapEncoding(const PdfCMapEncoding& );
    ~PdfCMapEncoding();
    enum EBaseEncoding {
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfCMapEncoding, PoDoFo::PdfCMapEncoding);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfCMapEncoding-postdef.h"
#endif
