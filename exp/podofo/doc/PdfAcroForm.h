...
#include "__zz_cib_internal/podofo/doc/PdfAcroForm-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfAcroForm(PdfAcroForm&& rhs);
  public:
    PdfAcroForm(const PdfAcroForm& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfAcroForm, PoDoFo::PdfAcroForm);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfAcroForm-postdef.h"
#endif
