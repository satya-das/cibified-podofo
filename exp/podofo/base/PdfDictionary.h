...
#include "__zz_cib_internal/podofo/base/PdfDictionary-predef.h"
...
#  endif
   ...
   */
  class PdfDictionary : public ::PoDoFo::PdfOwnedDataType
  {
  public:
  ...
  public:
     ...
     */
    void Write(PdfOutputDevice* pDevice, EPdfWriteMode eWriteMode, const PdfEncrypt* pEncrypt, const PdfName& keyStop) const;
    /**
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfDictionary, PoDoFo::PdfDictionary);
  };
...
#include "__zz_cib_internal/podofo/base/PdfDictionary-postdef.h"
#endif
