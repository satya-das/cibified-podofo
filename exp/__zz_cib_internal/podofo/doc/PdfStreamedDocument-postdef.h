...
struct __zz_cib_Helper<::PoDoFo::PdfStreamedDocument, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfStreamedDocument>);
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class473::__zz_cib_classid))
  {}
  ...
  static __zz_cib_AbiType __zz_cib_new_0(::PoDoFo::PdfStreamedDocument* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfStreamedDocument*, const __zz_cib_MethodTable*, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_new_0>(
      __zz_cib_h_, __zz_cib_get_proxy_method_table(),
      __zz_cib_args...);
  }
  template <typename ..._Args>
  static __zz_cib_AbiType __zz_cib_new_1(::PoDoFo::PdfStreamedDocument* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfStreamedDocument*, const __zz_cib_MethodTable*, _Args...);
  ...
  static auto Close_3(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::Close_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto GetWriteMode_4(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetWriteMode_4>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto GetPdfVersion_5(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetPdfVersion_5>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsLinearized_6(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsLinearized_6>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsPrintAllowed_7(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsPrintAllowed_7>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsEditAllowed_8(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsEditAllowed_8>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsCopyAllowed_9(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsCopyAllowed_9>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsEditNotesAllowed_10(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsEditNotesAllowed_10>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsFillAndSignAllowed_11(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsFillAndSignAllowed_11>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsAccessibilityAllowed_12(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsAccessibilityAllowed_12>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsDocAssemblyAllowed_13(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsDocAssemblyAllowed_13>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto IsHighPrintAllowed_14(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::IsHighPrintAllowed_14>(
      __zz_cib_obj
      );
  }
  static PoDoFo::PdfDocument::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class417(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = PoDoFo::PdfDocument::__zz_cib_AbiType (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_to___zz_cib_Class417>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class417(PoDoFo::PdfDocument::__zz_cib_AbiType  __zz_cib_obj) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (PoDoFo::PdfDocument::__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_from___zz_cib_Class417>(__zz_cib_obj);
  }
  ...
  static __zz_cib_AbiType __zz_cib_release_handle(_T* __zz_cib_obj) {
    ...
    __zz_cib_::__zz_cib_Helper<::PoDoFo::PdfDocument>::__zz_cib_release_handle(__zz_cib_obj);
    return h;
  }
  static void __zz_cib_release_proxy(::PoDoFo::PdfStreamedDocument* __zz_cib_obj) {
