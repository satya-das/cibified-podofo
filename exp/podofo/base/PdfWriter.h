...
#include "__zz_cib_internal/podofo/base/PdfWriter-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfWriter(PdfWriter&& rhs);
  public:
    PdfWriter(const PdfWriter& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfWriter, PoDoFo::PdfWriter);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfWriter-postdef.h"
#endif
