...
#include "__zz_cib_internal/podofo/doc/PdfFontMetricsBase14-predef.h"
...
namespace PoDoFo
{
  ...
  */
  class PdfFontMetricsBase14 : public ::PoDoFo::PdfFontMetrics
  {
  public:
    PdfFontMetricsBase14(PdfFontMetricsBase14&& rhs);
  public:
    PdfFontMetricsBase14(const PdfFontMetricsBase14& );
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontMetricsBase14, PoDoFo::PdfFontMetricsBase14);
  };
...
#include "__zz_cib_internal/podofo/doc/PdfFontMetricsBase14-postdef.h"
#endif
