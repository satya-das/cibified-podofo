...
#include "__zz_cib_internal/podofo/base/PdfMemStream-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfMemStream : public ::PoDoFo::PdfStream
  {
  public:
    PdfMemStream(PdfMemStream&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfMemStream, PoDoFo::PdfMemStream);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfMemStream-postdef.h"
#endif
