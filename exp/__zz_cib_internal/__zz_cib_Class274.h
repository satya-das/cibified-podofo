...
struct __zz_cib_Helper<::__zz_cib_stl_helpers::vector_iterator<char const >, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::__zz_cib_stl_helpers::vector_iterator<char const >>);
  using __zz_cib_AbiType = typename _T::__zz_cib_AbiType;
  using _ProxyClass = _T;
  friend class ::__zz_cib_stl_helpers::vector_iterator<char const >;
  CibPoDoFo::__zz_cib_local_proxy_mgr<_ProxyClass> proxyMgr;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class274::__zz_cib_methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class274::__zz_cib_classid))
  {}
...
template<>
class vector_iterator<char const >
{
public:
  vector_iterator(const vector_iterator<char const >& __zz_cib_param0)
    : __zz_cib_stl_helpers::vector_iterator<char const >(__zz_cib_MyHelper::__zz_cib_copy_0(
  ...
  using const_reference = typename std::conditional<std::is_pointer_v<value_type>, std::remove_const_t<value_type>, typename std::iterator_traits<char const *>::reference>::type;
  vector_iterator()
    : __zz_cib_stl_helpers::vector_iterator<char const >(__zz_cib_MyHelper::__zz_cib_new_2(
      ))
    {}
  ::__zz_cib_stl_helpers::vector_iterator<char const >::reference operator*() const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >::reference>(
      __zz_cib_MyHelper::__zz_cib_OperatorMul_3<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >::reference>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::vector_iterator<char const >::pointer operator->() const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >::pointer>(
      __zz_cib_MyHelper::__zz_cib_OperatorArrow_4<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >::pointer>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::vector_iterator<char const >& operator++() {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_5<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::vector_iterator<char const > operator++(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_6<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
  ...
  ::__zz_cib_stl_helpers::vector_iterator<char const >& operator--() {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_7<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::vector_iterator<char const > operator--(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_8<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(__zz_cib_param0)>(std::move(__zz_cib_param0))
      )
    );
  }
  ::__zz_cib_stl_helpers::vector_iterator<char const >::reference operator[](::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type n) const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >::reference>(
      __zz_cib_MyHelper::__zz_cib_OperatorIndex_9<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >::reference>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(n)>(std::move(n))
      )
    );
  }
  ::__zz_cib_stl_helpers::vector_iterator<char const >& operator+=(::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type n) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorPlusEq_10<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(n)>(std::move(n))
      )
    );
  }
  ::__zz_cib_stl_helpers::vector_iterator<char const > operator+(::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type n) const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorPlus_11<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(n)>(std::move(n))
      )
    );
  ...
  ::__zz_cib_stl_helpers::vector_iterator<char const >& operator-=(::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type n) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorMinusEq_12<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(n)>(std::move(n))
      )
    );
  ...
  ::__zz_cib_stl_helpers::vector_iterator<char const > operator-(::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type n) const {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorMinus_13<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(n)>(std::move(n))
      )
    );
  }
  bool operator==(const ::__zz_cib_stl_helpers::vector_iterator<char const >& rhs) {
  ...
  ::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type operator-(const ::__zz_cib_stl_helpers::vector_iterator<char const >& rhs) {
      return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type>(
      __zz_cib_MyHelper::__zz_cib_OperatorMinus_20<__zz_cib_::__zz_cib_AbiType_t<::__zz_cib_stl_helpers::vector_iterator<char const >::difference_type>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(rhs)>(rhs)
      )
    );
...
private:
  __ZZ_CIB_TEMPLATE_CLASS_INTERNALS(__ZZ_CIB_CLASS_NAME(vector_iterator<char const >), __ZZ_CIB_CLASS_NAME(__zz_cib_stl_helpers::vector_iterator<char const >));
};
}
