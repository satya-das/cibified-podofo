...
#include "__zz_cib_internal/podofo/base/PdfObject-predef.h"
...
namespace PoDoFo
{
   ...
   * \see WriteObject()
   */
  class PdfObject : public ::PoDoFo::PdfVariant
  {
  public:
  ...
  public:
     ...
     */
    void WriteObject(PdfOutputDevice* pDevice, EPdfWriteMode eWriteMode, PdfEncrypt* pEncrypt, const PdfName& keyStop) const;
...
#  endif
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfObject, PoDoFo::PdfObject);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
namespace __zz_cib_ {
template <>
struct __zz_cib_UsesMethodTable<::PoDoFo::PdfObject> : std::true_type
{
};
}

#include "__zz_cib_internal/podofo/base/PdfObject-postdef.h"
#endif
