...
class __zz_cib_Generic<::PoDoFo::PdfStream> : public ::PoDoFo::PdfStream {
  ...
  explicit __zz_cib_Generic(__zz_cib_AbiType h) : ::PoDoFo::PdfStream(h), __zz_cib_h_(h) {}
public:
  static ::PoDoFo::PdfStream* __zz_cib_from_handle(__zz_cib_AbiType h) {
    return new __zz_cib_Generic(h);
  }
  void EndAppendImpl() override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::EndAppendImpl_26>(
      __zz_cib_h_
    );
  }
  void BeginAppendImpl(const ::std::vector<::PoDoFo::EPdfFilter>& vecFilters) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(vecFilters)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::BeginAppendImpl_24>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(vecFilters)>(vecFilters)
    );
  }
  ::PoDoFo::pdf_long GetLength() const override {
    ...
    return __zz_cib_FromAbiType<::PoDoFo::pdf_long>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetLength_16>(
        __zz_cib_h_
      )
    );
  }
  void GetCopy(char** pBuffer, ::PoDoFo::pdf_long* lLen) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pBuffer)>, __zz_cib_AbiType_t<decltype(lLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetCopy_17>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(pBuffer)>(std::move(pBuffer)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(lLen)>(std::move(lLen))
    );
  ...
  void Write(::PoDoFo::PdfOutputDevice* pDevice, ::PoDoFo::PdfEncrypt* pEncrypt) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pDevice)>, __zz_cib_AbiType_t<decltype(pEncrypt)>);
  ...
  void GetCopy(::PoDoFo::PdfOutputStream* pStream) const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (const __zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pStream)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetCopy_18>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(pStream)>(std::move(pStream))
    );
  }
  const char* GetInternalBuffer() const override {
    ...
    return __zz_cib_FromAbiType<const char*>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetInternalBuffer_22>(
        __zz_cib_h_
      )
    );
  }
  void AppendImpl(const char* pszString, size_t lLen) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_AbiType, __zz_cib_AbiType_t<decltype(pszString)>, __zz_cib_AbiType_t<decltype(lLen)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::AppendImpl_25>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(pszString)>(std::move(pszString)),
      __zz_cib_::__zz_cib_ToAbiType<decltype(lLen)>(std::move(lLen))
    );
  ...
  ::PoDoFo::pdf_long GetInternalBufferSize() const override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::pdf_long>(__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_FromAbiType<::PoDoFo::pdf_long>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::GetInternalBufferSize_23>(
        __zz_cib_h_
      )
    );
  }
...
namespace __zz_cib_ {
template<>
::PoDoFo::PdfStream* __zz_cib_Helper<::PoDoFo::PdfStream>::__zz_cib_create_proxy(__zz_cib_AbiType h) {
  switch(__zz_cib_get_class_id(&h)) {
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class373::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfFileStream>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfFileStream>::__zz_cib_cast_from___zz_cib_Class400(h)
    );
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class382::__zz_cib_classid:
    return __zz_cib_Helper<PoDoFo::PdfMemStream>::__zz_cib_from_handle(
      __zz_cib_Helper<PoDoFo::PdfMemStream>::__zz_cib_cast_from___zz_cib_Class400(h)
    );
  default: break;
  }
  return ::__zz_cib_::__zz_cib_Generic<::PoDoFo::PdfStream>::__zz_cib_from_handle(h);
}
}
namespace __zz_cib_ {
using namespace ::PoDoFo;
...
struct __zz_cib_Delegator<::PoDoFo::PdfStream> {
  ...
  static void __zz_cib_decl __zz_cib_delete_9(::PoDoFo::PdfStream* __zz_cib_obj) {
    __zz_cib_Helper<::PoDoFo::PdfStream>::__zz_cib_release_handle(__zz_cib_obj);
    delete __zz_cib_obj;
  }
};
};
...
namespace __zz_cib_ {
template<>
const __zz_cib_MethodTable* __zz_cib_Helper<::PoDoFo::PdfStream>::__zz_cib_get_proxy_method_table() {
