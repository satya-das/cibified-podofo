...
#include "__zz_cib_internal/podofo/doc/PdfAnnotation-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfAnnotation : public ::PoDoFo::PdfElement
  {
  public:
    PdfAnnotation(PdfAnnotation&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfAnnotation, PoDoFo::PdfAnnotation);
  };
...
#include "__zz_cib_internal/podofo/doc/PdfAnnotation-postdef.h"
#endif
