...
struct __zz_cib_Helper<::PoDoFo::PdfContents, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfContents>);
  ...
  friend class ::PoDoFo::PdfContents;
  CibPoDoFo::__zz_cib_local_proxy_mgr<_ProxyClass> proxyMgr;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class413::__zz_cib_methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class413::__zz_cib_classid))
  {}
  ...
  static __zz_cib_AbiType __zz_cib_copy_0(::PoDoFo::PdfContents* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfContents*, const __zz_cib_MethodTable*, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_copy_0>(
      __zz_cib_h_, __zz_cib_get_proxy_method_table(),
      __zz_cib_args...);
  }
  template <typename ..._Args>
  static __zz_cib_AbiType __zz_cib_new_1(::PoDoFo::PdfContents* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfContents*, const __zz_cib_MethodTable*, _Args...);
  ...
  template <typename ..._Args>
  static __zz_cib_AbiType __zz_cib_new_2(::PoDoFo::PdfContents* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfContents*, const __zz_cib_MethodTable*, _Args...);
  ...
  template <typename ..._Args>
  static __zz_cib_AbiType __zz_cib_new_3(::PoDoFo::PdfContents* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfContents*, const __zz_cib_MethodTable*, _Args...);
  ...
  template <typename ..._Args>
  static __zz_cib_AbiType __zz_cib_new_4(::PoDoFo::PdfContents* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfContents*, const __zz_cib_MethodTable*, _Args...);
  ...
  static auto GetContents_6(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetContents_6>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto GetContentsForAppending_7(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetContentsForAppending_7>(
      __zz_cib_obj
      );
  }
  ...
  static void __zz_cib_release_proxy(::PoDoFo::PdfContents* __zz_cib_obj) {
