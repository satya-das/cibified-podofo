...
public:
  ...
  void Finish() override {
    ...
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Finish_0>(
      __zz_cib_h_
    );
  }
  void BeginAppendStream(const ::PoDoFo::PdfStream* pStream) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_Proxy, __zz_cib_AbiType_t<decltype(pStream)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::BeginAppendStream_1>(
      __zz_cib_h_,
  ...
  void EndAppendStream(const ::PoDoFo::PdfStream* pStream) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_Proxy, __zz_cib_AbiType_t<decltype(pStream)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::EndAppendStream_2>(
      __zz_cib_h_,
      __zz_cib_::__zz_cib_ToAbiType<decltype(pStream)>(std::move(pStream))
    );
  }
  void WriteObject(const ::PoDoFo::PdfObject* pObject) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_Proxy, __zz_cib_AbiType_t<decltype(pObject)>);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::WriteObject_3>(
      __zz_cib_h_,
  ...
  void ParentDestructed() override {
    using __zz_cib_proc = __zz_cib_AbiType_t<void>(__zz_cib_decl *) (__zz_cib_Proxy);
    __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::ParentDestructed_4>(
      __zz_cib_h_
    );
  }
...
struct __zz_cib_Delegator<::PoDoFo::PdfVecObjects::Observer> : public ::PoDoFo::PdfVecObjects::Observer {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_0(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfVecObjects::Observer>(__zz_cib_proxy, __zz_cib_mtbl);
  }
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfVecObjects::Observer>::__zz_cib_release_proxy)
  };
...
public:
  ...
  ::PoDoFo::PdfStream* CreateStream(::PoDoFo::PdfObject* pParent) override {
    using __zz_cib_proc = __zz_cib_AbiType_t<::PoDoFo::PdfStream*>(__zz_cib_decl *) (__zz_cib_Proxy, __zz_cib_AbiType_t<decltype(pParent)>);
    return __zz_cib_FromAbiType<::PoDoFo::PdfStream*>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::CreateStream_0>(
        __zz_cib_h_,
...
struct __zz_cib_Delegator<::PoDoFo::PdfVecObjects::StreamFactory> : public ::PoDoFo::PdfVecObjects::StreamFactory {
  ...
  using __zz_cib_Proxy = __zz_cib_Delegatee::__zz_cib_Proxy;
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_0(__zz_cib_Proxy __zz_cib_proxy, const __zz_cib_MethodTable* __zz_cib_mtbl) {
    return new __zz_cib_::__zz_cib_Generic<::PoDoFo::PdfVecObjects::StreamFactory>(__zz_cib_proxy, __zz_cib_mtbl);
  }
  static void __zz_cib_decl __zz_cib_delete_1(__zz_cib_Delegatee* __zz_cib_obj) {
        delete __zz_cib_obj;
  }
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfVecObjects::StreamFactory>::__zz_cib_release_proxy)
  };
