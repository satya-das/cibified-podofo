...
struct __zz_cib_Helper<::PoDoFo::PdfFontType1Base14, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PoDoFo::PdfFontType1Base14>);
  ...
  friend class ::PoDoFo::PdfFontType1Base14;
  CibPoDoFo::__zz_cib_local_proxy_mgr<_ProxyClass> proxyMgr;
  using __zz_cib_methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class446::__zz_cib_methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFo_GetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class446::__zz_cib_classid))
  {}
  ...
  static __zz_cib_AbiType __zz_cib_new_1(::PoDoFo::PdfFontType1Base14* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfFontType1Base14*, const __zz_cib_MethodTable*, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_new_1>(
      __zz_cib_h_, __zz_cib_get_proxy_method_table(),
      __zz_cib_args...);
  }
  template <typename ..._Args>
  static __zz_cib_AbiType __zz_cib_new_2(::PoDoFo::PdfFontType1Base14* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfFontType1Base14*, const __zz_cib_MethodTable*, _Args...);
  ...
  static auto EmbedFontFile_3(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::EmbedFontFile_3>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  ...
  static void __zz_cib_release_proxy(::PoDoFo::PdfFontType1Base14* __zz_cib_obj) {
