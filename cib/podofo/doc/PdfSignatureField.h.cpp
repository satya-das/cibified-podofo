...
struct __zz_cib_Delegator<::PoDoFo::PdfSignatureField> : public ::PoDoFo::PdfSignatureField {
  ...
  static ::PoDoFo::PdfField* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class421(::PoDoFo::PdfSignatureField* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::PoDoFo::PdfSignatureField* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class421(::PoDoFo::PdfField* __zz_cib_obj) {
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfSignatureField>::__zz_cib_cast_to___zz_cib_Class421),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::PoDoFo::PdfSignatureField>::__zz_cib_cast_from___zz_cib_Class421)
  };
