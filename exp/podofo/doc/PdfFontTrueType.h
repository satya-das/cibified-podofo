...
#include "__zz_cib_internal/podofo/doc/PdfFontTrueType-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfFontTrueType : public ::PoDoFo::PdfFontSimple
  {
  public:
    PdfFontTrueType(PdfFontTrueType&& rhs);
  public:
    ~PdfFontTrueType();
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontTrueType, PoDoFo::PdfFontTrueType);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfFontTrueType-postdef.h"
#endif
